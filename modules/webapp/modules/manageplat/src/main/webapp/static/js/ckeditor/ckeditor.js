 ...
 (function() {
    ...
    d.range = function(l) {
        ...
        d.range.prototype = {
            ...
            setStart: function(u, v) {
                var w = this;
                if (u.type == 1 && f.$empty[u.getName()]) v = u.getIndex(),
                u = u.getParent();
                w.startContainer = u;
                w.startOffset = v;
                if (!w.endContainer) {
            ...
            setEnd: function(u, v) {
                var w = this;
                if (u.type == 1 && f.$empty[u.getName()]) v = u.getIndex() + 1,
                u = u.getParent();
                w.endContainer = u;
                w.endOffset = v;
                if (!w.startContainer) {
    ...
    j.add('contextmenu', {
        ...
        function q(r, s) {
            ...
            r = r.replace(/\b(nbsp|shy|gt|lt|amp|apos|quot)(?:,|$)/g, 
            function(A, B) {
                var C = s ? '&' + B + ';': v[B],
                D = s ? v[B] : '&' + B + ';';
                t[C] = D;
    ...
    i.image_removeLinkByEmptyURL = true; (function() {
        ...
        function m(q, r) {
            ...
            s && (s = s.replace(/(?:-(?:moz|webkit)-)?(?:start|auto)/i, '')); ! s && r && (s = q.getComputedStyle('direction') == 'rtl' ? 'right': 'left');
            return s;
        };
        function n(q) {
    ...
    j.add('resize', {
        init: function(m) {
            ...
            if (n.resize_enabled !== false) {
                ...
                q,
                r,
                s = (n.resize_dir == 'both' || n.resize_dir == 'horizontal') && n.resize_minWidth != n.resize_maxWidth,
    ...
    i.smiley_descriptions = ['smiley', 'sad', 'wink', 'laugh', 'frown', 'cheeky', 'blush', 'surprise', 'indecision', 'angry', 'angel', 'cool', 'devil', 'crying', 'enlightened', 'no', 'yes', 'heart', 'broken heart', 'kiss', 'mail']; (function() {
        ...
        n,
        o = (b.ie6Compat ? ['.%1 table.%2,', '.%1 table.%2 td, .%1 table.%2 th', '{', 'border : #d3d3d3 1px dotted', '}'] : ['.%1 table.%2,', '.%1 table.%2 > tr > td, .%1 table.%2 > tr > th,', '.%1 table.%2 > tbody > tr > td, .%1 table.%2 > tbody > tr > th,', '.%1 table.%2 > thead > tr > td, .%1 table.%2 > thead > tr > th,', '.%1 table.%2 > tfoot > tr > td, .%1 table.%2 > tfoot > tr > th', '{', 'border : #d3d3d3 1px dotted', '}']).join('');
            ...
            init: function(C) {
                ...
                function() {
                    ...
                    function V(W) {
                        ...
                        if (c && C.config.enterMode != 1) X.on('selectionchange', 
                        function() {
                            var af = X.getBody(),
                            ag = C.getSelection(),
                    ...
                    C.addMode('wysiwyg', {
                        ...
                        getData: function() {
                            ...
                            if (W.ignoreEmptyParagraph) ab = ab.replace(m, 
                            function(ac, ad) {
                                return ad;
                    ...
                    function(W) {
                        ...
                        if (X && !X.isLocked) {
                            ...
                            B.call(this, W);
                            C.fire('updateSnapshot'); ! Y && C.resetDirty();
                        }
                    },
                    null, null, 1);
                });
                ...
                function K(L) {
                    ...
                    function() {
                        ...
                        M.setAttribute('contentEditable', true); ! L && K(1);
                    });
                };
                C.on('insertElement', 
                function(L) {
            ...
            init: function(z) {
                ...
                function() {
                    ...
                    if (c) {
                        ...
                        if ((b.ie7Compat || b.ie6Compat) && E.$.compatMode != 'BackCompat') G.on('mousedown', 
                        function(N) {
                            N = N.data.$;
                            function O(Q) {
                                Q = Q.data.$;
