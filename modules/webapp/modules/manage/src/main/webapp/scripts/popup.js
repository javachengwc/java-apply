...
function winOpen(sName, sUrl,iWidth,iHeight,bCentre) {
	...
	sFeatures="height="+ iHeight +",width=" + iWidth +",top=" + iTop +",left=" + iLeft +",status=no, toolbar=no, menubar=no, location=no, resizable=no, scrollbars=no";
	var objWin;
...
Popup.prototype = {
    ...
    build: function() {
        ...
        var path = "images/popup/dialogclose.gif";
