	    ...
	    <div style="text-align:center;">
	       <table cellpadding="0" cellspacing="1" border="0" style="width:500px;font-size:12px;" bgcolor="#d4d4d4">
	           ...
	           <tr>  
	             ...
	             <td class="td_input"><input id="lv" name="lv" type="text" value="${userCaptain.lv}" readonly="readonly" disabled="disabled" /> 
	             </td>
	           </tr>
	           <tr>  
	             <td class="td_title">生命值</td>
	             <td class="td_input"><input id="life" name="life" type="text" value="${userCaptain.life}" readonly="readonly" disabled="disabled" /> 
	             </td>
	           </tr>
	           <tr>  
	             <td class="td_title">技能等级</td>
	             <td class="td_input"><input id="skillLv" name="skillLv" type="text" value="${userCaptain.skillLv}" readonly="readonly" disabled="disabled" /> 
	             </td>
	           </tr>
	           <tr>  
