...
<%
	// set default values
	Integer[] defaultPageSizes = new Integer[]{10,20,30,50};
	...
	<td>
		<div class="box">
			...
			<div class="paginationControls">
				<span class="buttonLabel" style="color:#01a8d8;">当前 ${page.thisPageFirstElementNumber} - ${page.thisPageLastElementNumber} 条,共 ${page.totalCount} 条记录</span>
