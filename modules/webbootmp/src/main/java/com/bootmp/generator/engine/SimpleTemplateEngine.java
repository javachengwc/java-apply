package com.bootmp.generator.engine;

import com.bootmp.generator.engine.base.GunsTemplateEngine;
...
public class SimpleTemplateEngine extends GunsTemplateEngine {
    ...
    protected void generatePageEditHtml() {
        String path = StringUtil.format(super.getContextConfig().getProjectPath() + getPageConfig().getPageEditPathTemplate(),
    ...
    protected void generatePageAddHtml() {
        String path = StringUtil.format(super.getContextConfig().getProjectPath() + getPageConfig().getPageAddPathTemplate(),
                super.getContextConfig().getBizEnName(), super.getContextConfig().getBizEnName());
    ...
    protected void generatePageInfoJs() {
        String path = StringUtil.format(super.getContextConfig().getProjectPath() + getPageConfig().getPageInfoJsPathTemplate(),
                super.getContextConfig().getBizEnName(), super.getContextConfig().getBizEnName());
    ...
    protected void generatePageJs() {
        String path = StringUtil.format(super.getContextConfig().getProjectPath() + getPageConfig().getPageJsPathTemplate(),
                super.getContextConfig().getBizEnName(), super.getContextConfig().getBizEnName());
    ...
    protected void generatePageHtml() {
        String path = StringUtil.format(super.getContextConfig().getProjectPath() + getPageConfig().getPagePathTemplate(),
                super.getContextConfig().getBizEnName(), super.getContextConfig().getBizEnName());
    ...
    protected void generateController() {
        String controllerPath = StringUtil.format(super.getContextConfig().getProjectPath() + super.getControllerConfig().getControllerPathTemplate(),
                StringUtil.capitalize(super.getContextConfig().getBizEnName()));
    ...
    protected void generateSqls() {
        String path = StringUtil.format(super.getContextConfig().getProjectPath() + super.sqlConfig.getSqlPathTemplate(),
                StringUtil.capitalize(super.getContextConfig().getBizEnName()));
