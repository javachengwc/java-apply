...
_932(this,q);
}},currentText:"Today",cleanText:"Clean",closeText:"Close",okText:"Ok",buttons:[{text:function(_945){
...
$(this).closest("div.combo-panel").panel("close");
    ...
    return $(_949).datebox("options").cleanText;

},handler : function(_950) {
    $(_950).combo('setValue', '').combo('setText', '');
    $(this).closest("div.combo-panel").panel("close");
