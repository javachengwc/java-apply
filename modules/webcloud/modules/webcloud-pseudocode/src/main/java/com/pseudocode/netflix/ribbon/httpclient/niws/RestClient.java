package com.pseudocode.netflix.ribbon.httpclient.niws;
...
import com.pseudocode.netflix.ribbon.httpclient.NFHttpClient;
...
public class RestClient extends AbstractLoadBalancerAwareClient<HttpRequest, HttpResponse> {
    ...
    public void initWithNiwsConfig(IClientConfig clientConfig) {
        ...
        this.config.getProperties().put(ApacheHttpClient4Config.PROPERTY_CONNECT_TIMEOUT,
                Integer.parseInt(String.valueOf(ncc.getProperty(CommonClientConfigKey.ConnectTimeout))));
        this.config.getProperties().put(ApacheHttpClient4Config.PROPERTY_READ_TIMEOUT,
