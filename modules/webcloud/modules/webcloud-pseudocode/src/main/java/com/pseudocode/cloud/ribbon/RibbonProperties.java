...
import static com.pseudocode.netflix.ribbon.core.client.config.CommonClientConfigKey.PoolKeepAliveTime;
import static com.pseudocode.netflix.ribbon.core.client.config.CommonClientConfigKey.PoolKeepAliveTimeUnits;
import static com.pseudocode.netflix.ribbon.core.client.config.CommonClientConfigKey.Port;
import static com.pseudocode.netflix.ribbon.core.client.config.CommonClientConfigKey.SecurePort;
import static com.pseudocode.netflix.ribbon.core.client.config.DefaultClientConfigImpl.DEFAULT_CONNECTION_IDLE_TIMERTASK_REPEAT_IN_MSECS;
import static com.pseudocode.netflix.ribbon.core.client.config.DefaultClientConfigImpl.DEFAULT_CONNECT_TIMEOUT;
import static com.pseudocode.netflix.ribbon.core.client.config.DefaultClientConfigImpl.DEFAULT_FOLLOW_REDIRECTS;
import static com.pseudocode.netflix.ribbon.core.client.config.DefaultClientConfigImpl.DEFAULT_MAX_CONNECTIONS_PER_HOST;
import static com.pseudocode.netflix.ribbon.core.client.config.DefaultClientConfigImpl.DEFAULT_MAX_TOTAL_CONNECTIONS;
import static com.pseudocode.netflix.ribbon.core.client.config.DefaultClientConfigImpl.DEFAULT_OK_TO_RETRY_ON_ALL_OPERATIONS;
import static com.pseudocode.netflix.ribbon.core.client.config.DefaultClientConfigImpl.DEFAULT_POOL_KEEP_ALIVE_TIME;
import static com.pseudocode.netflix.ribbon.core.client.config.DefaultClientConfigImpl.DEFAULT_POOL_KEEP_ALIVE_TIME_UNITS;
import static com.pseudocode.netflix.ribbon.core.client.config.DefaultClientConfigImpl.DEFAULT_PORT;
import static com.pseudocode.netflix.ribbon.core.client.config.DefaultClientConfigImpl.DEFAULT_READ_TIMEOUT;
...
public class RibbonProperties {
    ...
    public boolean isOkToRetryOnAllOperations() {
        return get(CommonClientConfigKey.OkToRetryOnAllOperations, DEFAULT_OK_TO_RETRY_ON_ALL_OPERATIONS);
    }
