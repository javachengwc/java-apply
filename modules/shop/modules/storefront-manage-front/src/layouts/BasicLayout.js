...
class BasicLayout extends React.PureComponent {
  ...
  getPageTitle() {
    ...
    if (currRouterData && currRouterData.name) {
      title = `${currRouterData.name} - 门店管理后台`;
    }
    return title;
  }
  getBashRedirect = () => {
  ...
  render() {
        ...
        <Layout>
          ...
          <Footer style={{ padding: 0 }}>
            <GlobalFooter
              copyright={
                <Fragment>
                  Copyright <Icon type="copyright" /> 2019 门店管理后台
                </Fragment>
              }
            />
          </Footer>
    ...
    const showLoading = Object.keys(loading.effects).some(item => loading.effects[item]);
    return (
      <Spin spinning={showLoading} tip="正在加载" wrapperClassName="global-loading">
