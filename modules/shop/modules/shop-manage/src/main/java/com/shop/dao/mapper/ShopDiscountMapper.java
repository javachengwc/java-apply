...
import com.shop.model.pojo.ShopDiscountExample;
...
public interface ShopDiscountMapper {
     ...
     */
    int countByExample(ShopDiscountExample example);
     ...
     */
    @Insert({
        "insert into shop_discount (shop_id, discount_name, ",
        "begin_time, end_time, ",
        "discount_state, discount_range, ",
        "discount_products, discount_type, ",
        "discount_rule, create_time, ",
        "update_time)",
        "values (#{shopId,jdbcType=INTEGER}, #{discountName,jdbcType=VARCHAR}, ",
    ...
    ShopDiscount selectByPrimaryKey(Long id);
