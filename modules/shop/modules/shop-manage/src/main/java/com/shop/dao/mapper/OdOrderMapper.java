...
public interface OdOrderMapper {
    ...
    @Insert({
        ...
        "user_id, user_name, ",
        "user_comment, shop_id, ",
        "shop_name, shop_comment, ",
        ...
        "#{userComment,jdbcType=VARCHAR}, #{shopId,jdbcType=BIGINT}, ",
        "#{shopName,jdbcType=VARCHAR}, #{shopComment,jdbcType=VARCHAR}, ",
    ...
    @Select({
        ...
        "shop_id, shop_name, shop_comment, create_time, is_overbuy, is_cancel, cancel_time, ",
        "cancel_type, cancel_reason, update_time, updater, price_amount, postage, exchange_score, ",
        "exchange_cash, coupon_no, coupon_price, discount_id, discount_type, discount_desc, ",
        "discount_rule, discount_price, pay_state, pay_time, pay_account, trade_pay_id, ",
        "pay_channel, pay_id, receiver_province_id, receiver_province_name, receiver_city_id, ",
        "receiver_city_name, receiver_area_id, receiver_area_name, receiver_address, ",
        "receiver_name, receiver_mobile, receiver_tele, receiver_address_id, receive_time, ",
        "deliver_time, deliver_time_limit, remind_deliver_count, express_id, express_name, ",
        "express_no",
        "from od_order",
        "where id = #{id,jdbcType=BIGINT}"
    })
