...
insert into sys_resource values(13,'售后管理','/shop/aftersale/aftersale.do',8,1,1,'');
insert into sys_resource values(14,'维权管理','/shop/aftersale/safeguard.do',8,1,1,'');
insert into sys_resource values(15,'投诉管理','/shop/aftersale/complain.do',8,1,1,'');
...
insert into sys_resource values(23,'新订单管理','',0,1,1,'');
insert into sys_resource values(24,'新订单列表','/shop/order/shopOrder.do',23,1,1,'');
