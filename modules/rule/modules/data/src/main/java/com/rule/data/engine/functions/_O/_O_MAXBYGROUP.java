 ...
 * <hr> 分组计数 </hr>
 */
public class _O_MAXBYGROUP extends Function {
    public static final String NAME = _O_MAXBYGROUP.class.getSimpleName();
    ...
    private Map<String, Double> init(CalInfo calInfo, String serviceName
            , Map<String, Object> param, String colBy, String colCal) throws RengineException, CalculateException {
