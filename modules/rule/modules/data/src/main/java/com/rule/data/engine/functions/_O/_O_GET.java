...
public class _O_GET extends Function {
    public static final String NAME = _O_GET.class.getSimpleName();
    ...
    public Object eval(CalInfo calInfo, Object[] args) throws RengineException {
        ...
        String reqKey = DataUtil.getStringValue(args[1]);
        ...
        if (trueCache == null) {
            ...
            final D2Data d2Data =
                    Cache4D2Data.getD2Data(servicePo, calInfo.getParam(),
            ...
            if (d2Data.getData().length > 1) {
                throw new RengineException(serviceName, NAME + "结果集多于一行, 行数为:" + d2Data.getData().length
                        + ", 参数为:" + JSON.toJSONString(calInfo.getParam()));
            }
