...
public final class SEARCH extends Function {
    ...
    public Object eval(CalInfo calInfo, Object[] args) throws RengineException, CalculateException {
        ...
        final String target = DataUtil.getStringValue(args[0]).toUpperCase();
        final String source = DataUtil.getStringValue(args[1]).toUpperCase();
        int start = 1;
        ...
        if (ret == 0) {
            throw new CalculateException("SEARCH未找到对应字符串");
        }
