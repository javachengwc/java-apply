...
public class MailSenderWithAuth{
  ...
  public static void main(String[] args){
    Message2 msg=new Message2("java_mail@citiz.net",   //发送者的邮件地址
  ...
  public void sendMail(Message2 msg){
    Socket socket=null;
    try{
...
class Message2{  //表示邮件
  ...
  public Message2(String from,String to, String subject, String content){
    this.from=from;
    this.to=to;
